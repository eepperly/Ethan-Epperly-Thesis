...
for i = 1:2
    ...
    for s_idx = 1:length(s_list)
        ...
        for trial = 1:num_trials
            ...
            hutchpp_iso_errs(s_idx,trial,i) = abs(hutchpp_reiso(@(X) A*X,n,s)-trA) / trA;
            xtrace_errs(s_idx,trial,i) = abs(xtrace(@(X) A*X,n,s)-trA) / trA;
            xtrace_iso_errs(s_idx,trial,i) = abs(xtrace_reiso(@(X) A*X,n,s)-trA) / trA;
            xnystrace_errs(s_idx,trial,i) = abs(xnystrace(@(X) A*X,n,s)-trA) / trA;
            xnystrace_iso_errs(s_idx,trial,i) = abs(xnystrace_reiso(@(X) A*X,n,s)-trA) / trA;
        end
    end
end
...
exportgraphics(gcf,"../figs/fig_15_2_a.png")
saveas(gcf,"../figs/fig_15_2_a.fig")
...
exportgraphics(gcf,"../figs/fig_15_3_b.png")
saveas(gcf,"../figs/fig_15_3_b.fig")